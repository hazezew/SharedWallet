...
public class ProcessSchedulerPage extends CommonElements {
    private WebDriver driver;
    private WebDriverWait wait;
    private Actions action;

    public ProcessSchedulerPage(WebDriver driver) {
        this.driver = driver;
    ...
    public void verifyProcessSchedulerSearchResults(String schedulerName) {

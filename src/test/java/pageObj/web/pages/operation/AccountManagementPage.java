...
public class AccountManagementPage extends CommonElements {
    ...
    public void enterNameInToSearchField(String accountName) {
    ...
    public void verifyAccountManagementSearchResults(String accountName) {
        List<WebElement> searchResults = driver.findElements(By.xpath("//td[contains(text(), '" + accountName + "')]"));
